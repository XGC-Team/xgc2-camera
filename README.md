...
repos only include a launch; they do not vendor another capture stack.
...
| `d435` | [xgc2-camera-d435](https://github.com/XGC-Team/xgc2-camera-d435) | Full D435 / D435i product: Intel `realsense2_camera`, URDF, XGC2 launch |

Any other robot that mounts the same camera clones `xgc2-camera-d435` (or
